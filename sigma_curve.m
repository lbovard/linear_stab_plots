...
i=1;
%get dt, make better
sigma_name=strcat('kz.',num2str(i),'.0.sigma.',num2str(N),'.re.',num2str(Re),'.0.fh.',num2str(Fh),'.');
totE_name=strcat('kz.',num2str(i),'.0.sigma.',num2str(N),'.re.',num2str(Re),'.0.fh.',num2str(Fh),'.');
...
dlmwrite('fh0.inf.re20000.512.dat',results,'precision',15);
